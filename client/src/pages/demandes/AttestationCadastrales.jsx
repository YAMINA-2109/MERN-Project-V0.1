...
const AttestionCadastrales = () => {
  ...
  const getdata = async ()=>{
      ...
      const res = await instance.post('/api/demandes/attCadastraleDemande', {},{
        headers: {
            Cookie: Object.entries(cookies).map(([key, value]) => `${key}=${value}`).join('; ')
        }
      })
      setData(res.data.attCadastrales)
      console.log(res);
  }
  useEffect(() => {
    getdata()
...
export default AttestionCadastrales;