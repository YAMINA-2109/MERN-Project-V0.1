...
const initialState ={name: "", prénom: "", age:"", ExtraitNaissance:"", CNI:"", DemandeDesInfos:"", documents:"", fredha:"", plansDeMasse:""};

const Znc = () => {
    const [formData, setFormData] = useState(initialState);
    const { name ,prénom , age, ExtraitNaissance, CNI, DemandeDesInfos, documents, fredha, plansDeMasse} = formData;
    ...
    const handlSoumition = async (e)=>{
        ...
        try {
            ...
            const res = await newDemandeRequest.post("/api/demandes/registreZnc", {
              ...formData,
              ExtraitNaissance: url1, CNI:url2, DemandeDesInfos: url3, documents: url4, fredha: url6, plansDeMasse:url7
            },{
                headers: {
